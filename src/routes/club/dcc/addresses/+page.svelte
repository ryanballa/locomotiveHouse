	...
	<table>
		...
		<tbody>
			<tr>
				...
				<td>Bob</td>
				<td>
					<Button on:click={() => toggleButton({ num: 99, status: 'active' })} type="warning"
						>Deactivate</Button
					>
				</td>
			</tr>
			<tr>
				...
				<td>Frank</td>
				<td
					><Button on:click={() => toggleButton({ num: 987, status: 'active' })} type="warning"
						>Deactivate</Button
					></td
				>
			</tr>
			<tr>
				<th scope="row">6618</th>
				<td><span class="in-use-flag false">false</span></td>
				<td>Ryan</td>
				<td
					><Button on:click={() => toggleButton({ num: 6618, status: 'inactive' })} type="positive"
						>Activate</Button
					></td
				>
			</tr>
